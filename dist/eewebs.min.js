...
function on_message(a){if("init"==a.type){var d="";jsparse(a).filter(function(a){return 385==a.id}).sort(function(a,c){return a.x>c.x?1:0}).sort(function(a,c){return a.y>c.y?1:0}).forEach(function(a){d+=a.args[1]});a=document.createElement("iframe");a.width="100%";a.height="100%";a.frameBorder="0";document.body.getElementsByTagName("div")[0].appendChild(a);a.contentWindow.document.open();a.contentWindow.document.write(d);a.contentWindow.document.close();conn.disconnect()}}
